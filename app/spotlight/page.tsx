...
export default function Spotlight() {
  ...
  const currentSpotlight = {
    ...
    going to students and families who really need it. It's not just good for business—it's good for my soul."`,
    impact: [
      { metric: '2,500+', label: 'Meals redistributed' },
      { metric: '85%', label: 'Waste reduction' },
      { metric: '₦450K', label: 'Value of food rescued' },
  ...
  const pastSpotlights = [
    ...
    },
    {
      ...
      image: '🌾',
      achievement: 'Donated surplus produce worth ₦200K',
